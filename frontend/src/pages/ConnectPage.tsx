/**
 * Unauthenticated landing — triggers Privy login modal.
 */
...
export default function ConnectPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-aegis-bg px-4">
      ...
      <button
        onClick={login}
        className="w-full max-w-sm rounded-xl bg-aegis-accent px-8 py-3.5 font-semibold text-white transition hover:opacity-90"
      >
        Connect Wallet
      </button>
